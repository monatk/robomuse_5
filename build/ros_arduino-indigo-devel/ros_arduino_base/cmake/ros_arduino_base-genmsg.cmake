...
get_filename_component(_filename "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv" NAME_WE)
add_custom_target(_ros_arduino_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ros_arduino_base" "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv" ""
)
...
_generate_srv_cpp(ros_arduino_base
  "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(ros_arduino_base
  "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ros_arduino_base
)

### Generating Module File
_generate_module_eus(ros_arduino_base
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ros_arduino_base
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(ros_arduino_base_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(ros_arduino_base_generate_messages ros_arduino_base_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv" NAME_WE)
add_dependencies(ros_arduino_base_generate_messages_eus _ros_arduino_base_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ros_arduino_base_geneus)
add_dependencies(ros_arduino_base_geneus ros_arduino_base_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ros_arduino_base_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(ros_arduino_base
  "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_arduino_base
)

### Generating Module File
_generate_module_nodejs(ros_arduino_base
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_arduino_base
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ros_arduino_base_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ros_arduino_base_generate_messages ros_arduino_base_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/monalisa/rm5_nav_ws/src/ros_arduino-indigo-devel/ros_arduino_base/srv/UpdateGains.srv" NAME_WE)
add_dependencies(ros_arduino_base_generate_messages_nodejs _ros_arduino_base_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ros_arduino_base_gennodejs)
add_dependencies(ros_arduino_base_gennodejs ros_arduino_base_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ros_arduino_base_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ros_arduino_base)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/ros_arduino_base
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(ros_arduino_base_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_arduino_base)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ros_arduino_base
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(ros_arduino_base_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
